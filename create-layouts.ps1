# Script to create _layouts directory and files

# Create directory
New-Item -ItemType Directory -Path "_layouts" -Force | Out-Null
...
"@ | Out-File -FilePath "_layouts\lezione.html" -Encoding UTF8

Write-Host "✓ Created _layouts directory and files"
